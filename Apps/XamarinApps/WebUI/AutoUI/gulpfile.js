...
pipes.processedDataDev = function() {
    return gulp.src(paths.data)
        .pipe(gulp.dest(paths.distDev + '/data/'));
};

pipes.processedDataProd = function() {
    return gulp.src(paths.data)
        .pipe(gulp.dest(paths.distProd + '/data/'));
};
...
pipes.builtAppDev = function() {
    return es.merge(pipes.builtIndexDev(), pipes.builtPartialsDev(), pipes.processedImagesDev(), pipes.processedDataDev(), pipes.processedFontsDev());
};
